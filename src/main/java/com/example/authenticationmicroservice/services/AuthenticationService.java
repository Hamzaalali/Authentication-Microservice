...
public class AuthenticationService {
    ...
    private DecodedJWT validToken(String token, String secret) {
        Algorithm algorithm = Algorithm.HMAC256(secret.getBytes());
    ...
    public void logout(String accessToken) throws FailedToLogoutException {
        try {
            DecodedJWT decodedJWT = validToken(accessToken, "access_token_secret");
